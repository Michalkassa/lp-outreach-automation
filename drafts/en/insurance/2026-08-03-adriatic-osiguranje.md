---
lp: Adriatic Osiguranje
to: nino.pavic@adriatic-osiguranje.hr
contact: Nino Pavić
bridge: fit - a regional book where new money has been going into government paper
category_label: European real asset debt
word_count: 125
language: en
structure: v5
tracker_flag: [UNVERIFIED] — Agram Group like Euroherc — treat both rows as one conversation — group liquidity-first posture
---
