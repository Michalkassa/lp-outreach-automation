---
lp: UnipolSai Assicurazioni
to: investor.relations@unipol.it
contact: Riccardo Baudi
bridge: fit - a balance sheet looking for yield it can hold with confidence
category_label: European real asset debt
word_count: 129
language: en
structure: v5
tracker_flag: [LIKELY] — Baudi confirmed as CIO (Bloomberg, MarketScreener). Published IR inbox used: the only address on file was a PEC (certif
---
