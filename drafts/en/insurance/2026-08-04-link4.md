---
lp: Link4
to: sudzinska.grazyna@link4.pl
contact: Grazyna Sudzinska
bridge: fit - a balance sheet with scale enough to hold a distinct credit allocation
category_label: European real asset debt
word_count: 130
language: en
structure: v5
tracker_flag: [UNVERIFIED] — PZU subsidiary — coordinate with PZU row
---
