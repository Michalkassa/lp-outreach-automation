---
lp: TUZ Ubezpieczenia
to: jaroslaw.matusiewicz@tuz.pl
contact: Jaroslaw Matusiewicz
bridge: fit - a sizeable book looking to diversify without adding equity risk
category_label: European real asset debt
word_count: 123
language: en
structure: v5
salutation: VERIFY - Mr. inferred from the first name
tracker_flag: [UNVERIFIED] — sub-scale
---
