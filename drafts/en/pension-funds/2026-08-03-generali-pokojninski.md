---
lp: Generali Pokojninski
to: saso.smigic@generali-investments.si
contact: Sašo šmigić
bridge: fit - a regional pension book with room to diversify beyond its core holdings
category_label: niche European private credit strategies
word_count: 131
language: en
structure: v5
tracker_flag: [UNVERIFIED] — CLUSTER→generali-italia — no email in import — verify contact title
---
