# Cometa
updated: 2026-07-19
score: 90/100  (calibration v4 leniency 2026-07-21; was 72)

## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — metalworkers — Italy's largest negoziale
- Domicile: Italy
- Regulator: COVIP
- AUM: [VERIFY — largest negoziale, ~€14B; 524,867 members end-2025 (FundsPeople/search)]
- Ownership: bilateral (unions + employers) governance; investments via external SGR mandates
- Alternatives allocation: CONFIRMED own real-economy FoF program (FundsPeople) [VERIFY private debt share]
...
## Bridge Candidates
1. Their own FoF: Cometa built a proprietary real-economy FoF (FundsPeople) — Valori's niche European distressed/special-situations credit is the segment such programs structurally miss
...
## Summary
Cometa: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
