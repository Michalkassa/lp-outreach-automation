...
score: 66/100
## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — railway (FS group) workers
- Domicile: Italy
- Regulator: COVIP
...
## Summary
Fondo Eurofer: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
