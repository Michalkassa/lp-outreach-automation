...
score: 74/100
## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — tertiary/commerce workers — top-3 by size
- Domicile: Italy
- Regulator: COVIP
- AUM: [VERIFY — OECD lists Fonte among Italy's largest; ~€5B likely]
- Ownership: bilateral (unions + employers) governance; investments via external SGR mandates
- Alternatives allocation: [VERIFY] Economia Reale participation — one of 18?
...
## Bridge Candidates
1. Scale + sector precedent: a top-3 fund in a market where peers write €14–30M FIA tickets
...
## Summary
Fondo Fonte: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
