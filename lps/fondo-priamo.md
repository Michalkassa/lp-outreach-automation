...
score: 68/100
## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — public transport workers
- Domicile: Italy
- Regulator: COVIP
- AUM: [VERIFY — ~€3B likely]
- Ownership: bilateral (unions + employers) governance; investments via external SGR mandates
- Alternatives allocation: [VERIFY]
...
## Bridge Candidates
1. Peer precedent + infrastructure-adjacent membership
...
## Summary
Fondo Priamo: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
