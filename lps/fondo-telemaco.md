...
score: 68/100
## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — telecom workers
- Domicile: Italy
- Regulator: COVIP
- AUM: [VERIFY — ~€2.5B likely]
...
## Bridge Candidates
1. Peer precedent in size class
...
## Summary
Fondo Telemaco: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
