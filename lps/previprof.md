...
score: 56/100
## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — professional-studios employees [VERIFY entity]
- Domicile: Italy
- Regulator: COVIP
- AUM: [VERIFY — small]
- Ownership: bilateral (unions + employers) governance; investments via external SGR mandates
- Alternatives allocation: no contact provided
...
## Summary
Previprof: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
