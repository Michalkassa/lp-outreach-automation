...
score: 74/100
## Data
- Type: Fondo pensione negoziale (contractual/industry fund) — Veneto regional multi-sector fund
- Domicile: Italy
- Regulator: COVIP
- AUM: [VERIFY — ~€2B likely]
- Ownership: bilateral (unions + employers) governance; investments via external SGR mandates
- Alternatives allocation: [likely] local private-debt-style investing tradition — VERIFY current program
...
## Bridge Candidates
1. Territorial credit culture: their local-economy investing tradition [VERIFY] is philosophically closest to Valori's bilateral niche of any Italian fund
...
## Summary
Solidarieta Veneto: Italian negoziale — see score rationale in flags; the sector's confirmed private-debt FoF precedent and in-range tickets are the core case, [VERIFY] fund-level participation and AUM.
